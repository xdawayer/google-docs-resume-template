...
# REPLACE_WITH_* / TODO(human) below, rename student-internship.draft.md -> student-internship.md,
...
# wordUrl: https://example.com/downloads/student-internship.docx # optional DOCX fallback
linkStatus: unverified # the link-health monitor (M2) sets this to "available"

thumbnail:
  src: src/assets/templates/student-internship.png # TODO(human): add the real screenshot (E6)
  width: 1600
  height: 2071
