...
# REPLACE_WITH_* / TODO(human) below, rename software-engineer.draft.md -> software-engineer.md,
...
# wordUrl: https://example.com/downloads/software-engineer.docx # optional DOCX fallback
linkStatus: unverified # the link-health monitor (M2) sets this to "available"

thumbnail:
  src: src/assets/templates/software-engineer.png # TODO(human): add the real screenshot (E6)
  width: 1600
  height: 2071
