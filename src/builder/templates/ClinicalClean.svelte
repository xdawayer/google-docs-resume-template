...
<style>
  /* Clinical — calm, trustworthy healthcare resume. Signature: a teal accent bar
     to the LEFT of every section heading + a teal-ruled left-aligned masthead.
     Single column, scanner-first. */
  .sheet {
    --ink: #1c2b30;
    --muted: #5a6b70;
    --accent: var(--rb-accent, #0e7490);
    --hair: #dbe3e5;
    background: #fff;
    color: var(--ink);
