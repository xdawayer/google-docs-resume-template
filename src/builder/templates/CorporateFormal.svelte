...
<style>
  /* Corporate — conservative, formal resume. Signature: the name framed by a
     top+bottom navy rule "letterhead" block, with navy uppercase headings under
     full-width navy rules. Single column, scanner-first, dense. */
  .sheet {
    --ink: #1b232e;
    --muted: #586575;
    --accent: var(--rb-accent, #1f3a5f);
    background: #fff;
    color: var(--ink);
    font-family: var(--rb-font, "Helvetica Neue", Arial, sans-serif);
    font-size: calc(10.2pt * var(--rb-scale, 1));
    line-height: calc(1.42 * var(--rb-line-scale, 1));
    width: 210mm;
    min-height: 297mm;
